...
export default function TweetCard({onDelete,index,id,username,content,likeCount,rtCount,replyCount}) {
    ...
    const {likedTweets, setLikedTweets} = useContext(UserContext);
